...
class HilfenQuoteReplyInfoResponse(BaseModel):
    """
    Schema for Hilfen Quote Reply info.
    
    Matches eurobot's QuoteReplyInfoResponse structure (identical message and channel IDs).
