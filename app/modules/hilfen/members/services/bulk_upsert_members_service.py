...
from app.modules.hilfen.members.schemas.bulk_upsert_request import (
...
class BulkUpsertMembersService:
    def __init__(self, db: AsyncSession):
        self.db = db
        self.single_upsert_service = UpsertHilfenMemberService(db)

    async def execute(self, payload: List[HilfenInsertMemberRequest]) -> BulkUpsertResultData:
        successful = []
        failed = []
